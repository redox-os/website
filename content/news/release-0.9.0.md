...
- Huge improvements to portability of Linux/BSD programs
...
- A 100% Rust `libm`
- Significant progress on ARM64 (Aarch64), including partial support for Raspberry Pi 3B+
- Contain (Redox's sandboxing driver) has been expanded and is available as a demo
...
- Lots of new documentation, including examples, troubleshooting and a FAQ
